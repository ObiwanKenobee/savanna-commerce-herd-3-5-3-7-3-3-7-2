...
Please help me get started! 🌍`;
  ...
  if (hasError) {
    return (
      <nav className="bg-gradient-to-r from-red-500 to-red-600 shadow-lg fixed top-0 w-full z-50">
        <div className="w-full px-4 py-3">
          <div className="flex items-center justify-center">
            <span className="text-white text-sm">
              Navigation error - please refresh page
            </span>
          </div>
        </div>
      </nav>
          ...
          <div className="flex items-center space-x-8">
            ...
            >
              ...
              <div className="hidden lg:block">
                <h1 className="text-lg font-bold text-white">Enterprise</h1>
            ...
            {userRole === "retailer" && (
              <div className="flex items-center space-x-3 w-full">
                ...
                <div className="hidden xl:flex items-center space-x-2">
                  <Switch
                    checked={cheetahMode}
                    onCheckedChange={setCheetahMode}
                    className="data-[state=checked]:bg-[#FFD700]"
                  />
                  <span className="text-xs text-white">Fast Mode</span>
                </div>
              </div>
            )}
